...
{
    public class ServiceAPIWooCommerce
    {
        [ApiController]
        [Route("woocommerce")]
        public class WooCommerce : ControllerBase
        {
            private readonly IHttpClientFactory _httpClientFactory;
            public WooCommerce(IHttpClientFactory httpClientFactory)
            {
            ...
            public async Task<IActionResult> ListProducts(string? name_Product)
            {
                var client = _httpClientFactory.CreateClient();
            ...
            public async Task<IActionResult> UpdateProductWooCommerce(int? _product_id, [FromBody] UpdateStock product)
            {
                var client = _httpClientFactory.CreateClient();
